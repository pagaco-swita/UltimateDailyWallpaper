...
#ifndef DOWNLOAD_WIKIMEDIA_COMMONS_POTD_H
#define DOWNLOAD_WIKIMEDIA_COMMONS_POTD_H
...
class download_wikimedia_commons_potd : public QObject
{
    Q_OBJECT

public:
    download_wikimedia_commons_potd();
    ~download_wikimedia_commons_potd();

    void get_wikimedia_commons_potd(bool downloadthumb, QString _picturedir, QString lang,
                                    int year, int month, int day);

    int existing_pageid;

signals:
    void download_successful(QString _description, QString _copyright, QString _provider,
...
private:
    ...
    int check_exists();
    int create_thumbfile(QString picturedir, QString filename);
...
#endif // DOWNLOAD_WIKIMEDIA_COMMONS_POTD_H
